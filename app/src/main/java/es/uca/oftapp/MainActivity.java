    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_programa:
                Intent intentPrograma = new Intent(MainActivity.this, ProgramaActivity.class);
                startActivity(intentPrograma);
                return true;
            case R.id.action_fechas:
                Intent intentFechas = new Intent(MainActivity.this, FechasActivity.class);
                startActivity(intentFechas);
                return true;
            case R.id.action_localizacion:
                Intent intentLocalizacion = new Intent(MainActivity.this, LocalizacionActivity.class);
